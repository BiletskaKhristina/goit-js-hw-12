import{a as w,S as v,i as a}from"./assets/vendor-Do60_h77.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))u(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&u(c)}).observe(document,{childList:!0,subtree:!0});function s(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function u(e){if(e.ep)return;e.ep=!0;const o=s(e);fetch(e.href,o)}})();const S="55650574-c6a86cff692a63e47839b2642",q="https://pixabay.com/api/";async function f(r,t){return(await w.get(q,{params:{key:S,q:r,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:15,page:t}})).data}const m=document.querySelector(".gallery"),y=document.querySelector(".loader"),p=document.querySelector(".load-more"),M=new v(".gallery a",{captionsData:"alt",captionDelay:250});function h(r){const t=r.map(s=>`
    ...
    `).join("");m.insertAdjacentHTML("beforeend",t),M.refresh()}function $(){m.innerHTML=""}function g(){y.classList.remove("hidden")}function L(){y.classList.add("hidden")}function B(){p.classList.remove("hidden")}function d(){p.classList.add("hidden")}const O=document.querySelector(".form"),E=document.querySelector(".load-more");let i="",n=1,l=0;O.addEventListener("submit",H);E.addEventListener("click",P);async function H(r){if(r.preventDefault(),i=r.target.elements.search.value.trim(),!!i){n=1,$(),d(),g();try{const t=await f(i,n);if(l=t.totalHits,!t.hits.length){a.error({message:"No images found"});return}h(t.hits),a.success({message:`Hooray! We found ${l} images.`}),b()}catch{a.error({message:"Something went wrong"})}finally{L()}}}async function P(){n+=1,d(),g();try{const r=await f(i,n);h(r.hits);const t=document.querySelector(".gallery").getBoundingClientRect();window.scrollBy({top:t.height*2,behavior:"smooth"}),b()}catch{a.error({message:"Failed to load more"})}finally{L()}}function b(){if(n*15>=l){d(),a.info({message:"We're sorry, but you've reached the end of search results."});return}B()}
